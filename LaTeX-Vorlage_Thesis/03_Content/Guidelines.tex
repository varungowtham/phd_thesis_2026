...
%------------------------------		
	\section{Template Structure}
		...
		\subsection{Makeindex}\label{subsec:makeindex}
			...
			\caption{Setting up biblatex and makeindex in texmaker}\label{fig:biblatexmakindex}
			\end{figure}			
		\subsection{Compatibility with PDF/A}
			...
			\caption[PDF/A validation]{PDF/A validation on \url{https://conversion.ub.tu-berlin.de/}}\label{fig:pdfa}
			\end{figure}
%------------------------------
...
Units can be written as $R=\SI{8.314}{\joule\per\mole\per\kelvin}$. You can also have ranges, e.g.~\SIrange{4}{10}{\kelvin}.
		\subsection{Figures}
			A template for a Figure is given in Fig.~\ref{fig:template_figure}. Use the protected space \textasciitilde{} between Fig. ~and \verb+\ref+. Figure~\ref{fig:template_figure} should not be abbreviated at the beginning of a sentence. Note that the \verb+\ref+ command is used here. In \autoref{subsec:autorefs}, the \verb+\autoref+ command is introduced.
			\begin{figure}[tbh]
				\centering
		...
		\subsection{Equations}
			An exemplary Equation is given in Eq.~\ref{eq:template_equation}. Use the protected space \textasciitilde{} between Eq. ~and \verb+\ref+. Equation~\ref{eq:template_equation} should not be abbreviated at the beginning of a sentence.
			\begin{equation}
				a=b.\label{eq:template_equation}
			\end{equation}
