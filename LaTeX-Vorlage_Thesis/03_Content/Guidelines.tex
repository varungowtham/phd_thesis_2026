...
%------------------------------			
	\section{Language: English or German?}\label{sec:language}
		...
		The name list of algorithms must be changed in the file b\_Commands.tex with the \verb+\listalgorithmcfname+ command (it is already there, just search for it) as there is no package option available. It is automatically added to the table of contentes using the package option \verb+dotocloa+.
