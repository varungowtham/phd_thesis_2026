...
%------------------------------
	\section{First Steps}
		\begin{itemize}
			...
			\item set the language of the document. Currently, you notice that this text is written in English while certain headings are in German. This is because the \verb+babel+ package is currently loaded with ngerman as default language and some other packages are loaded with the option \verb+german+ as well (see Section \ref{sec:language}).
...
%------------------------------			
	\section{General Information}
		\begin{enumerate}
			\item the current "Prüfungsordnung" overrides the following rules if they contradict the "Prüfungsordnung" . 
...
%------------------------------		
	...
	\section{Appearence}
		\begin{enumerate}
			...
			\item paragraphs should not start in the last two lines of a page ("Schusterjunge" or orphen) or end in the first two lines of a page ("Hurenkind" or widow). This is done with the \verb+nowidow+ package.
		\end{enumerate}
%------------------------------
