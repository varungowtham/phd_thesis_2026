...
\item change the necessary entries in meta.tex (i.e. your name and matriculation number)
\item add your own .bib file for your references
...
\item remove the guidelines chapter from this document
...
\item defines structure of the list of symbols
 - optional argument defines the class of a symbol (latin, greek, \dots)
