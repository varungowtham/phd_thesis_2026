...
\usepackage{datetime}		% package for dates
\usepackage[
...
\usepackage{mathptmx}		% contains the Times New Roman font
\usepackage[
	sc,						% with small caps
...
\usepackage[all]{nowidow}	% Schusterjungen and Hurenkinder
...
\usepackage[
    ...
    filecolor=magenta, 		% color for local refs
    menucolor=black, 		
    linkbordercolor=red, 	% color for links
    citebordercolor=blue,	% color for citations
    urlbordercolor=cyan,	% color for URLs
    %pagebackref,			% links to pages in references, not working with biblatex!
    pdfpagelabels, 			% correct generation of bookmarks
    hypertexnames=true, 	% correct generation of bookmarks
    linktocpage, 			% use page numbers for hyperrefs
]{hyperref}