...
\DeclareFieldFormat[article,inbook,incollection,inproceedings,patent,thesis,unpublished]{citetitle}{#1\midsentence\isdot}						% no quotation marks in citetitle

\DeclareFieldFormat[article,inbook,incollection,inproceedings,patent,thesis,unpublished]{title}{#1\midsentence\isdot} 							% no quotation marks in title

\DeclareFieldFormat[article]{title}{#1\midsentence\isdot}	
...
%\DeclareFieldFormat[inproceedings]{booktitle}{#1\midsentence\isdot}	
