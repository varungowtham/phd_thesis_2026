...
%------------------------------
	\section{First Steps}
		\begin{enumerate}[label={\arabic*.}]
			...
			\item set the language of the document in the a\_Packages.tex file with the \verb+babel+ package. Currently, you notice that this text is written in English while certain headings are in German. This is because the \verb+babel+ package is currently loaded with ngerman as default language (see \autoref{sec:language}).			
	...
	\section{\LaTeX{} Editor Settings and Maintenance}
		\subsection{Biblatex and Makeindex}\label{subsec:biblatexmakeindex}
			\begin{itemize}
				...
				\item Note that the paths for Mac or Linux distributions have not been verified yet. If these path differ from what is stated here, please forward us the corrected instructions (\href{mailto:c.hoffmann@tu-berlin.de}{c.hoffmann@tu-berlin.de})				
