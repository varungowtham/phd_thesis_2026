...
\textbf{Note that the }\verb+pdfx+\textbf{ package cannot ensure that all you included PDFs, for example figures, fulfill the PDF/A standard. Hence, it is recommended to check for PDF/A compatibility of your document on a regular basis.}
