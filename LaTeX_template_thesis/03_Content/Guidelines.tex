...
\begin{enumerate}
	...
	\item remove the guidelines chapter from this document by deleting it and removing it from the \path{0_Text.tex}\index{Files!0\_Text.tex} file in the folder 03\_Content
