...
\begin{itemize}
	...
	\item simple generation of List of Codes with the \verb+listings+ package and KOMA script
...
\begin{enumerate}
	...
	\item f\_CodeLanguageSpecifications
	      \begin{itemize}
		      ...
		      \item more information can be found in the listings documentation
	      \end{itemize}
\end{enumerate}
\begin{figure}[tbh]
	\centering
