...
If you write your bachelor's or master's thesis (\verb+isDiss+=\texttt{false}), this template automatically includes the file \path{Task.pdf}, which is located in this folder and contains the task of your thesis. Simply scan your task as soon as you have received it, name it \path{Task.pdf}, and replace the current file.
%------------------------------
% SEC: LANGUAGE
%------------------------------				
...
\begin{description}
	\item[\TeX Live] manages the packages via the tlmgr (\TeX Live 2018) or tlshell (\TeX Live 2019). The GUI of the tlmgr is located in \path{texlive/year/bin/win32}. In this folder, you find a file called \path{tlmgr-gui.exe} or \path{tlshell.exe}, respectively. Use this program to update your packages.
	\item[MiK\TeX] manages the packages in the MiK\TeX\ console (package manager in older versions). Use this application to update your packages.
\end{description}
