...
\begin{lstlisting}[breaklines, caption={Setting up latexindent in Texmaker. If the \LaTeX\ distribution is in your system path, simply writing latexindent (without extension) instead of the whole path should suffice}, float=tbh, label={code:latexindent}, language=latex]
