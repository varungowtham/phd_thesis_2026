...
\begin{enumerate}[label={\arabic*{}.}]
	\item Add a user command for \verb+arara+ to Texmaker\footnote{\url{https://tex.stackexchange.com/questions/107989/integration-of-arara-in-texmaker}, January 2019}. \textbf{Due to system path issues}, is has been proven advantageous to put the complete path to \verb+arara+ in the this command:
	      \begin{verbatim}
"path_to_texlive\year\bin\win32\arara.exe" %.tex
\end{verbatim}
...
\textbf{Arara 4.0 (\TeX Live 2018):} In 2018, version 4.0 of \verb+arara+ was published. With this version, the indent rule is already part of the \LaTeX\ distribution and does not have to be added manually. The procedure is exactly the same as above. You can simply skip step 3 of the instructions.
%------------------------------
