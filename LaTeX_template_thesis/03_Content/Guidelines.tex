...
\textbf{Currently (March 2019), there is an error message when using this template on Overleaf with the }\verb+nomencl+\textbf{ and the }\verb+scrhack+\textbf{ package. If you want to use this template on Overleaf, do not load the }\verb+scrhack+\textbf{ package. In addition, you need to upload a current version of the }\verb+nomencl+\textbf{ package to the Overleaf project folder.}
\begin{figure}[tbh]
	\centering
