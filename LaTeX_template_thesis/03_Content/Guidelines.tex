...
%------------------------------		
	\section{Template Structure}
		...
		\subsection{02\_Prematter}
			The following files are located in this folder:
			\begin{enumerate}
				\item a\_Cover\_Diss.tex and a\_Cover\_BA\_MA.tex
				\begin{itemize}
					\item creates the cover page
					\item main.tex loads either a\_Cover\_BA\_MA.tex (cover of a bachelor/master thesis) or a\_Cover\_Diss.tex (cover of a dissertation), depending on the value of \verb+isDiss+ set in c\_Meta.tex
				\end{itemize}
