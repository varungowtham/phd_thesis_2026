...
%------------------------------
	\section{First Steps}
		\begin{enumerate}[label={\arabic*.}]
			...
			\item check whether you can compile this document without errors (this should always be the case as long as all necessary packages are installed). This template was successfully compiled with a texlive 2017 distribution. \textbf{Some problems appeared when users did not have the newest versions of the used packages of this template. If you run into trouble, please update all your packages.\footnote{\url{https://tex.stackexchange.com/questions/55437/how-do-i-update-my-tex-distribution}, January 2019}}
	...
	\section{Dependencies} 
			...
			\begin{itemize}
				...
				\item command line for setting up biblatex in texmaker (see \autoref{fig:biblatexmakindex}): 
					\begin{enumerate}
						...
						in texlive, biber is located in \verb+bin/win32+
				...
				\item command line for setting up makeindex in texmaker (see \autoref{fig:biblatexmakindex}): 
					\begin{enumerate}
						...
						in texlive, makeindex is located in \verb+bin/win32+
				...
				\item Note that the paths for Mac or a Linux distribution have not been verified yet. If the path differs from what is stated here, please forward us the corrected instructions (\href{mailto:c.hoffmann@tu-berlin.de}{c.hoffmann@tu-berlin.de})				
		...
		\subsection{Support for Overleaf or other online editors}\label{subsec:overleaf}
			\begin{itemize}
				...
				\item The only necessary change is the support for the \verb+nomentbl+ package. As this package needs makeindex, you have to tell the Overleaf compiler how to proceed. This information is contained in the latexmkrc file in this template folder. Simply upload the latexmkrc file to the Overleaf project and Overleaf should compile this file correctly. In some cases, you may first have to clear the cache to remove old temporary files\footnote{\url{https://www.overleaf.com/learn/how-to/Clearing_the_cache}, January 2019}.
			\end{itemize}					
%------------------------------
% SEC: TEMPLATES
%------------------------------		
