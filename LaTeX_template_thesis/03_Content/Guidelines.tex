...
\begin{enumerate}[label={\arabic*.}]
	...
	\item install a suitable program for your literature. We recommend Jabref\footnote{\url{http://www.jabref.org/}, February 2019}. It is a Java-based, platform-independent program that generates appropriate .bib files for \LaTeX. A small introduction to Jabref is given in \autoref{subsec:references}.
