...
The following sections introduce a few extra features. None of them are necessary for a thesis, but they might be of use for some people.
...
\end{lstlisting}
	      This command executes the automatic file indenting for all files (and files in subfolders) that are states within the square brackets. An example is given in \autoref{fig:arara_30_latexindent}.
