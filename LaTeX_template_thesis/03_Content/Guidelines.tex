...
\path{a_Packages}\index{Files!a\_Packages.tex} & 
	...
	\end{myList} \end{minipage} \\
\path{b_Commands}\index{Files!b\_Commands.tex} & 
	\begin{minipage}[t]{\mycolumnwidth} \begin{myList}
		\item Commands regarding format and look of the document
	\end{myList} \end{minipage} \\
\path{c_Meta}\index{Files!c\_Meta.tex} & 
	\begin{minipage}[t]{\mycolumnwidth} \begin{myList}
...
\path{a_Cover}\index{Files!a\_Cover.tex} & 
	\begin{minipage}[t]{\mycolumnwidth} \begin{myList}
		\item Cover page. Depending on the values of \verb+isDiss+ set in \path{c_Meta.tex}, the correct cover is printed. The covers for both thesis and dissertation are shown in \autoref{fig:covers}.
	\end{myList} \end{minipage} \\
