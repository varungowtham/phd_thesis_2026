...
\begin{enumerate}
	...
	\item \path{e_AbbreviationDefinitions.tex}\index{Files!e\_AbbreviationDefinitions.tex}
	      ...
	      \end{itemize}
	\item \path{f_Header_Footer.tex}\index{Files!f\_Header\_Footer.tex}
	      \begin{itemize}
		      \item defines headers and footers
	      \end{itemize}
	\item \path{g_CodeLanguageSpecifications.tex}\index{Files!g\_CodeLanguageSpecifications.tex}
	      \begin{itemize}
...
\begin{description}
	...
	\item[PSTricks] was designed for PostScript vector graphics\footnote{\url{http://www.tug.org/PSTricks/main.cgi/}, March 2019} and is available for all \LaTeX\ distributions.\footnote{\url{https://www.ctan.org/pkg/pstricks-base}, March 2019} Hence, it cannot directly be used with PDF\LaTeX. Generating PDFs is possible with the packages \verb+pdftricks+\footnote{\url{https://www.ctan.org/pkg/pdftricks}, March 2019} or \verb+pst-pdf+\footnote{\url{https://www.ctan.org/pkg/pst-pdf}, March 2019}
...
\centering
\includegraphics[width=2cm]{Logo_tub}
...
\begin{wraptable}{r}{0.4\textwidth}
	...
	\end{tabular}
\end{wraptable}
The \verb+wrapfig+\index{Packages!wrapfig} package can also be used for wrapped tables as shown in \autoref{tab:wrapped_table}. Again, make sure that the Table is small enough. In addition, it might be necessary that the text surrounding the wrapped table is a separate paragraph, i.e., empty lines above and below (see \LaTeX\ code).
