...
\begin{wraptable}{r}{0.4\textwidth}
	...
	\end{tabular}
\end{wraptable}
The \verb+wrapfig+\index{Packages!wrapfig} package can also be used for wrapped tables as shown in \autoref{tab:wrapped_table}. Again, make sure that the Table is small enough. In addition, make sure that the text surrounding the wrapped table is a separate paragraph, i.e., empty lines above and below (see \LaTeX\ code).
