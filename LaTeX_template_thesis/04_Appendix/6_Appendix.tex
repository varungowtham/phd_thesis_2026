...
\verb+\num{@}+						&	new number								\\
\verb+\parencite[@]{@}+				&	new paren cite with options				\\
\verb+\parencite{@}+				&	new paren cite without options			\\
...
\verb+\textcite[@]{@}+				&	new text cite with option				\\
\verb+\textcite{@}+					&	new text cite without option			\\
