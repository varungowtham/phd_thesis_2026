...
\NewAcroTemplate[list]{dbtalongtable}{
	...
	\acroheading%
	\acropreamble%
    \setlength\LTleft{0.5ex}    % Adjustment of left margin
    \begin{longtable}{>{\bfseries\sffamily}lp{\mydescriptionwidth}}
        \AcronymTable
    \end{longtable}
}
\acsetup{	
...
\makeindex[
	...
	title={\indextitle},	    		% title of the Index
