...
\usepackage[
	nomencl=false,			% do not use scrhack for nomencl
...
% set localization of SIunix package depending on the default language of the document
\newcommand{\SILangSpec}{}
\iflanguage{english}{\renewcommand{\SILangSpec}{US}}{\iflanguage{ngerman}{\renewcommand{\SILangSpec}{DE}}{}}
\usepackage[
