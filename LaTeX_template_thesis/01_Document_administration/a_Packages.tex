...
\usepackage{textcomp}		% supports the Text Companion fonts, which provide many text symbols, in the TS1 encoding
\usepackage[
...
%------------------------------
\usepackage{acro}			% package for list of abbreviations
