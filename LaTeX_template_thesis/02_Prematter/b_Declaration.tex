...
\end{otherlanguage}
\begin{otherlanguage}{ngerman}
\ifthenelse{\boolean{containsEN}}{%
\section*{Sperrvermerk zur Abschlussarbeit}
Die vorliegende Masterarbeit mit dem Titel \enquote{\mytitle} beinhaltet vertrauliche Daten der Firma \textbf{\firmenname}. Sie darf nur vom Erst- und Zweitgutachter sowie berechtigten Personen im Rahmen des Prüfungsverfahrens eingesehen werden. Eine Veröffentlichung und Vervielfältigung der Masterarbeit –- auch in Teilen -– ist innerhalb der Sperrfrist untersagt. Dritten darf diese Arbeit während der Sperrfrist nur mit der ausdrücklichen Genehmigung des Verfassers und Unternehmens zugänglich gemacht werden. Alle Rechte zum Erwerb und zur Anmeldung gewerblicher Schutzrechte, insbesondere zur Anmeldung von Patenten, Gebrauchsmustern und/oder Geschmacksmustern bleiben der Firma \textbf{\firmenname} vorbehalten.
}{}%
\end{otherlanguage}
}%