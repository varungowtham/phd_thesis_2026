	...
	%------------------------------		
		...
		\begin{titlepage}
			\begin{center}
				...
				\ifthenelse{\boolean{containsEN}}{\textbf{Achtung, diese Arbeit enthält einen Sperrvermerk aufgrund einer Geheimhaltungsvereinbarung mit der Firma \firmenname}}{}
			\end{center}				
		\end{titlepage}
		}
	}