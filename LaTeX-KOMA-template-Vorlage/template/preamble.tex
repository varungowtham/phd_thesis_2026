%% Time-stamp: <2013-02-25 10:58:32 vk>
%%%% === Disclaimer: =======================================================
%% created by
%%
%%      Karl Voit
...
%doc% \item Modify \myfile{colophon.tex} to meet your situation.
%doc%   \begin{itemize}
...
DIV=11,             %% set fixed DIV value for type area;
...
%doc%
%doc%
%doc% Use pdfx package in order to create a pdf of type PDF-A (1-b)
%doc%
%doc%
%doc%
%doc%
...
%% use package setspace for the title on the title page (set linespacing)
\usepackage{setspace}
