...
\input{template/title_Thesis_TU_Berlin}            %% include title page


\input{chapters/thanks}                %% this is a suggestion: you have to create this file on demand
\input{chapters/preface}              %% this is a suggestion: you have to create this file on demand
...
%% =========================================================================
\include{chapters/abstract}     %% include Abstract
...
\include{chapters/glossary}	    %% this is a suggestion: you have to create this file on demand
...
%% =========================================================================
 \include{chapters/introduction}        %% this is a suggestion: you have to create this file on demand
 \include{chapters/guidelines}             %% this is a suggestion: you have to create this file on demand
 \include{chapters/norms}             %% this is a suggestion: you have to create this file on demand
 \include{chapters/latex}             %% this is a suggestion: you have to create this file on demand
 \include{chapters/example-neu}             %% this is a suggestion: you have to create this file on demand
% \include{chapters/solution}            %% this is a suggestion: you have to create this file on demand
% \include{chapters/evaluation}          %% this is a suggestion: you have to create this file on demand
...
\include{appendix/programcode}  %% <---- this is a suggestion: you have to create this file on demand
